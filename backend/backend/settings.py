...
DATABASES = {
    'default': {
        ...
        'NAME': 'neondb',
        'USER': 'neondb_owner',
        'PASSWORD': 'npg_bznF18cTdCRN',
        'HOST': 'ep-bold-cloud-a8g5k5fw-pooler.eastus2.azure.neon.tech',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        }
...
AUTH_USER_MODEL = 'drivana.CustomUser'
...
EMAIL_HOST_PASSWORD = 'dhunvnebkzeaiodh'
